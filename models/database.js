...
const bcrypt = require('bcryptjs'); // Asegúrate de instalar esta librería con npm install bcryptjs
...
async function insertSampleData() {
  const Recipe = require('./recipe'); // Asegúrate de importar tu modelo de recetas
